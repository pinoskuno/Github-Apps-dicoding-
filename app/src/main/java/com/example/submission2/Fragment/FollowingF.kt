...
import com.example.submission2.ViewModel.FollowingVM
import com.example.submission2.databinding.FragmentDetailBinding

class FollowingF : Fragment(R.layout.fragment_detail){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this,
            ViewModelProvider.NewInstanceFactory()).get(FollowingVM::class.java)
        viewModel.setlisfFollowing(username)
